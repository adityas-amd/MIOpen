    ...
    stages{
        ...
        stage('Single GTest'){
            ...
            environment{
                ...
                execute_cmd_gtest = "bin/miopen_gtest --gtest_filter=-*DBSync*:*DeepBench*:*MIOpenTestConv*:*MIOpenDriver*:*GPU_GetitemBwd*.GetitemBwdTest*:*GPU_BNBWDSerialRun3D*:*GPU_BNFWDTrainSerialRun3D*:*GPU_Bwd_Mha*:*GPU_Fwd_Mha*:*GPU_UnitTestActivationDescriptor*:*CPU_Dump*"
